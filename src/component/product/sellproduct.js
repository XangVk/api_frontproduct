...
//s
    ...
    //         const data = await axios.post("http://localhost:3001/productsell/createproductsell", productadd, { headers: { Authorization: token } });
                    ...
                    <div className="w-55 h-100  ">
                        <div className="w-50 d-flex flex-direction-column pl-6 pb-1">
                            ...
                            <div className="position-relative ">
                                ...
                                />
                                <img src="http://localhost:3001/image/post/icon_search.png" className="h-30-px position-absolute top-0 right-42-l cursor-pointer" />
                            </div>
                        </div>
                                ...
                                productsell.length > 0 && productsell.map((item, index) =>
                                    <div className="w-30 max-height-213-px mx-3 max-width-180-px  position-relative mb-4">
                                        <div className=" d-flex flex-direction-column    box-shadow-default overflow-hidden position-relative" onClick={() => addproduct({ item: item })}>
                                            <img src={`http://localhost:3001/image/post/${item.image != "false" ? item.image : "noimage.jpg"}`} className="w-100 h-110-px min-h-110-px " />
