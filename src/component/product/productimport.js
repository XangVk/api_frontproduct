...
export default function ProductImport() {
    ...
    async function onaddproductimport() {
        ...
        try {
            ...
            const data = await axios.post("http://localhost:3001/productimport/createproductimport", productadd, { headers: { Authorization: token } });
    ...
    async function onaddproducts() {
        try {
            ...
            const data = await axios.post("http://localhost:3001/product/createproductimage", datas, { headers: { Authorization: token } });
