...
export default function EditUser({ data, editdata }) {
    ...
    const valuefirtsname = async (e) => {
        try {
            ...
            const datass = await axios.put(`http://164.92.98.3:3001/user/updateuser/${data._id}`, formdata);
    ...
    return (
        <div className="w-40 pb-5 pt-3 position bg-white border-radius-3-px ">
            <div className="d-flex flex-direction-column px-3">
                ...
                <img src={images != null ? images : `http://164.92.98.3:3001/image/post/noimage.jpg`} className="w-100-px h-100-px border-radius-50 m-auto" />
