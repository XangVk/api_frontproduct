...
export default function Sellproductreport() {
    ...
    async function getproductsell() {
        try {
            ...
            const data = await axios.get("http://164.92.98.3:3001/sellproduct/getsellproduct", { headers: { Authorization: token } });
            if (data.status == 200) {
    ...
    async function getproductselldate() {
        try {
            ...
            const data = await axios.get("http://164.92.98.3:3001/sellproduct/getsellproductdate", { params: datesell, headers: { Authorization: token } });
            if (data.status == 200) {
